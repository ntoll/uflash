...
def test_unhexlify_foreign_script():
    """
    Ensure that we can get the script back out of a hex file that's been
    generated by another program.
    """
    unhexlified = uflash.unhexlify(TEST_SCRIPT_FOREIGN)
    assert unhexlified == TEST_SCRIPT.decode('utf-8')
